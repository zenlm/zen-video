...
## Foundation
Built on **Wan2.2** (Alibaba, Apache-2.0) — chosen for permissive, commercial-friendly licensing.

## License
Apache License, Version 2.0 — see [LICENSE](LICENSE) and [NOTICE](NOTICE). Copyright 2025-2026 Zen Authors (https://zenlm.org).
